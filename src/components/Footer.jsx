...
const Footer = () => {
  return (
    <footer className="px-6 relative mt-44 overflow-hidden">
      <div className="max-w-7xl mx-auto">
            ...
            <div className="space-y-2">
              <Animated>
                <a
                  ...
                  className="flex item-center gap-1 text-zinc-600 hover:text-zinc-500"
                >
        ...
        <div className="border-t text-zinc-600 border-slate-200 py-4.5 flex justify-between items-center">
          <p>© {new Date().getFullYear()}. All Right Reserved</p>
          <p>
            Designed by <a href="https://greatstack.dev">GreatStack</a>
          </p>
        </div>
      </div>
